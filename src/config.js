...
export const TIER_INFO = {
  seed:{name:'Seed',icon:'🌱',desc:'Concrete, intuitive, jargon-free.'},
  growth:{name:'Growth',icon:'🌿',desc:'Introduces terminology, expects paragraphs.'},
  canopy:{name:'Canopy',icon:'🌳',desc:'Original analysis, engages with traditions.'},
};
export const STORAGE_KEY = 'trivium_progress_v1';
